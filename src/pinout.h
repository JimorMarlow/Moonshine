...
const int T_TOP_COLUMN_PIN = 9;             // - S2 GPIO9 t_top_column

const int F_DEFLEGMATOR_WATER_PIN = D1;     // - D1 GPIO5 flow_deflegmator_water
const int F_CONDENSER_WATER_PIN = D2;       // - D2 GPIO4 flow_condenser_water

const int TOUCH_BTN_PIN = 10;             // - S3 GPIO10 touch_btn